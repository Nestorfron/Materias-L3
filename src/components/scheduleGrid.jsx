...
const ScheduleGrid = () => {
  // Estructura de datos: cada día tiene un arreglo de objetos con materia y horario
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-semibold text-center mb-6 text-foreground-500">
        Horarios
      </h1>
      ...
      <div className="mb-6">
        ...
        <select
          id="group"
          className="text-foreground mt-1 block w-full px-4 py-2 border border-primary rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blueLiceo focus:border-blueLiceo transition duration-200"
          value={selectedGroup}
        ...
        <table className="min-w-full table-auto border-collapse">
          ...
          <tbody>
            {selectedSchedule[selectedDay].map((item, index) => (
              <tr
                key={index}
                className="hover:bg-blueLiceo-200 transition duration-200"
              >
                <td className="py-3 px-6 border-b text-left">{item.subject}</td>
                <td className="py-3 px-6 border-b text-left">{item.time}</td>
              </tr>
            ))}
          </tbody>
        </table>
